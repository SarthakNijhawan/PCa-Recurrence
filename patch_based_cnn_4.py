...
data_path = './expt_4/data_dump'
tmp_train_data_path = './expt_4/useful_patches'									# tmp dir for training. will be deleted b4 the program closes
val_data_path = data_path + '/valid'
tmp_probab_path = './expt_4/probab_maps_dump_tmp'
...
def patch_based_cnn_model(dropout_prob=0.5, l_rate=0.1):
	...
	convnet = Conv2D(128, 4, strides=1, padding='valid', activation=None, kernel_initializer='he_normal')(convnet)
	convnet = BatchNormalization(axis=3)(convnet)
	convnet = Activation('relu')(convnet)
	convnet = MaxPooling2D(pool_size=(2, 2), strides=2)(convnet)
